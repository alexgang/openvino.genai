...
struct Args {
    std::string ov_model_path = "model/GPTQ_INT4-FP16/modified_openvino_model.xml";
    std::string token_model_path = "model/GPTQ_INT4-FP16/openvino_tokenizer.xml";
    std::string detoken_model_path = "model/GPTQ_INT4-FP16/openvino_detokenizer.xml";
...
static void usage(const std::string& prog) {
    std::cout << "Usage: " << prog << " [options]\n"
        ...
        << "  -m, --model PATH        Chatglm OpenVINO model path (default: model/GPTQ_INT4-FP16/modified_openvino_model.xml)\n"
        << "  -token PATH             Tokenizer model path (default: model/GPTQ_INT4-FP16/openvino_tokenizer.xml)\n"
        << "  -detoken PATH           DeTokenizer model path (default: model/GPTQ_INT4-FP16/openvino_detokenizer.xml)\n"
